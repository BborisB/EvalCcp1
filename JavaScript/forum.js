...
if(categories==null)
{
    ...
    let cat1 = 
    {
        ...
        subjects: [{title: "Laitue", id: 1, auteur: "Boris", lastComment: "XX/XX/XXXX", messages: [{auteur: userTest, message: "Je ne vends pas de laitue, mais j'en mange.", date: "XX/XX/XXXX"}]}]
    };
    let cat2 = 
    {
        title: "Culture",
        ...
        subjects: [{title: "Laitue", id: 1, auteur: "Boris", lastComment: "XX/XX/XXXX", messages: [{auteur: userTest, message: "Je ne cultive pas la laitue, mais je la mange.", date: "XX/XX/XXXX"}]}]
    };
    let cat3 = 
    {
        title: "Cuisine",
        ...
        subjects: [{title: "Laitue", id: 1, auteur: "Boris", lastComment: "XX/XX/XXXX", messages: [{auteur: userTest, message: "Je ne cuisine pas la laitue, mais je la mange.", date: "XX/XX/XXXX"}]}]
    };
